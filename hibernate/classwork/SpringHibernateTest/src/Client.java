...
public class Client {
	...
	public static void getSessionFactory() {
		try {
			//Configuration conf=new Configuration();  //create Configuration object first

			//conf.configure("hibernate.cfg.xml");//populates the data of the configuration file  
		//	factory=conf.buildSessionFactory(); //then u can create session factory object and u can begin your transaction
