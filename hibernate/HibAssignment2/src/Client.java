...
public class Client {
	...
	public static void main(String args[]) {
		try
		{
			...
			Address add = new Address("saroornagar","Hyderabad","Telangana",03);
			Student std = new Student(7,"prakash",41,"CSE");
			std.setAddress(add);
			System.out.println("Hello");
			c.insertData(std,add);
			System.out.println("Hello");
			
			Address add2 = new Address("SR Nagar","Kerala","India",85);
			Student std2 = new Student(9,"kohli",31,"IT",add2);
